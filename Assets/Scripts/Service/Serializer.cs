...
public class Serializer : MonoBehaviour
{
    ...
    public IEnumerator InitializeFromJson(string json)
    {
        ...
        Vector3 forward = (last.pos - nextToLast.pos).normalized;
        Quaternion q = Quaternion.LookRotation(forward, Vector3.up);
        SplineNoise3D.AddSplineSegment(last.pos + forward * 40f, q, 10f, Vector4.zero, 0);//add a segment for the door to have space in
